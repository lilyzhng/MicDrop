...
const MainApp: React.FC = () => {
  ...
  // -- Report Logic --
const saveReport = useCallback(async (title: string, type: 'walkie' | 'hot-take' | 'teach' | 'interview' | 'readiness' | 'system-coding' | 'role-fit' | 'end-game', report: PerformanceReport) => {
      const userId = user?.id;
