...
VALUES (
    ...
    'To reach step n, you can come from step n-1 or n-2. So ways(n) = ways(n-1) + ways(n-2). This is the Fibonacci sequence.',
    'def climbStairs(n: int) -> int:\n    if n <= 2:\n        return n\n    prev, curr = 1, 2\n    for i in range(3, n + 1):\n        prev, curr = curr, prev + curr\n    return curr',
    'O(n)',
    'O(1)',
    '["Base cases: 1 step = 1 way, 2 steps = 2 ways", "For step i: ways[i] = ways[i-1] + ways[i-2]", "Only need to track previous two values", "Iterate from 3 to n", "Return final value"]',
